...
class Forvo(WebService):
    ...
    def _get_from_api(self):
        ...
        self.language = "zh"  # set language. Get language code from: https://forvo.com/languages-codes/
        url = 'https://apicorporate.forvo.com/api2/v1.2/d6a0d68b18fbcf26bcbb66ec20739492/word-pronunciations/word/' \
              '{}/language/' + self.language + '/order/rate-desc'.format(self.quote_word)
    ...
    def fld_mp3(self):
        ...
        filename = u'forvo_{}.mp3'.format(self.word)
